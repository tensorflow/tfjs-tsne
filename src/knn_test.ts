...
//     knnTechnique: string, dataTexture: WebGLTexture, dataFormat:
//     RearrangedData, numPoints: number, numDimensions: number, numNeighs:
//     number) {
//   it(`kNN increments the iterations
//       (${knnTechnique}, #neighs: ${numNeighs})`,
//      () => {
//        const knn = new tf_knn.KNNEstimator(
//            dataTexture, dataFormat, numPoints, numDimensions, numNeighs,
//            false);
...
// function checkHeap(distances: tf.Tensor, numPoints: number, numNeighs:
// number) {
//   const eps = 10e-5;
//   for (let i = 0; i < numPoints; ++i) {
//     const s = i * numNeighs;
